...
orb_dir = "/Users/lindamegner/MATS/MATS-Data/NADIR_geolocation/geolocation_test_final"
# directory where the maps are stored
map_dir = "/Users/lindamegner/MATS/MATS-Data/Polar_plot_final"
...
nb_core = 4 # number of CPU cores to use in multiprocessing (~ half of the cores available)
...
for i in range(len(orb_times)):
    ...
    for i in range(sets):
        parallel_geolocating(i,df_orb,temp_dir,geolocation)
