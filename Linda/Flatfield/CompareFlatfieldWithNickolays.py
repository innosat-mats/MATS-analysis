...
for i, channel in enumerate(CCDlist):
    ...
    flatfield_full=flatfield.make_flatfield(channel, calibration_file, plotresult=True, plotallplots=False)
    ...
    flatfield_binned=meanbin_image_with_BC(CCDitem, image_nonbinned=flatfield_full)
    #read flatfield from what is in calibration data and bin
    #flatfield_binnedold =calculate_flatfield(CCDitem)/npixinbin
