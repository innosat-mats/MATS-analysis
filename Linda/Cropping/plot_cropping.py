...
The script plots the different croppings based on a common field of view.

This script is based on the old script cropping_settings.py, which is used to generate cropping settings.
