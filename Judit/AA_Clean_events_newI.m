...
%This code takes all the event times from Ceona's list and asks to confirm
%that there is actually arurora in them. It also calculates the new
%intensity with the chosen filter and it saves it in the Structuresnew
%folder
